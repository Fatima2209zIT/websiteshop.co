...
export default function Products() {
  return (
    <div className="lg:w-[1440px] w-[410px] ">
      ...
      <div className=" gridlg:w-[400px] w-[358px] lg:h-[240px] h-[186.19px] absolute lg:top-[3461px] top-[3244px] lg:left-[100px] left-[16px] rounded-[20px] border border-[#0000001A] lg:px-[32px] lg:py-[28px] p-[24px] gap-[342px]">
